...
const static CGFloat kDeleteButtonWidth = 50.f;
...
- (id)initWithFrame:(CGRect)frame style:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        [_deleteButton setBackgroundImage:[UIImage imageNamed:@"personal_btn_quit_unpressed"] forState:UIControlStateNormal];
